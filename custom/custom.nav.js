var custom = {
    init_main_sections: function (a_sections) {
        ...
        a_sections.push({code: 'favs', type: 'expand-link-tiles', title: 'Favorites', description: 'Content favs', icon: './img/star.svg', id_content: 'custom-favs'});
    ...
    init_foot_sections: function (a_sections) {
        ...
        a_sections.push({code: 'mails', type: 'button', title: 'e-Mails', description: 'e-Mail list', icon: './img/email.svg', id_content: ''});
